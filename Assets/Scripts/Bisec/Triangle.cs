...
public class bTriangle
{
	...
	public bTriangle(ActiveNode<bVertex> t1, ActiveNode<bVertex> t2, ActiveNode<bVertex> t3)
	{
		n1 = t1;
		n2 = t2;
		n3 = t3;
	...
	public ActiveNode<bVertex> GetNode(int index)
	{
		...
		throw new UnityException("Bisec: bTriangle vertex out of bounds.");
	}
	...
	public Vector2 GetUV(int index)
	{
		...
		throw new UnityException("Bisec: bTriangle uv out of bounds.");
	}
